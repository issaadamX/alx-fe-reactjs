function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 sm:p-4 sm:p-6 md:p-8 max-w-xs sm:max-w-sm md:max-w-sm mx-auto my-10 sm:my-15 md:my-20 rounded-lg shadow-lg hover:shadow-xl">
      <img 
